...
class MedicamentoController extends Controller
{
    ...
    public function create()
    {
        ...
        $laboratorios = Laboratorio::pluck('nombre','id');
        $presentaciones = Presentacione::pluck('nombre','id');
        $sitios = Sitio::pluck('nombre','id');

        return view('medicamento.create', compact('medicamento','laboratorios','presentaciones','sitios'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('medicamento.edit', compact('medicamento','laboratorios','presentaciones','sitios'));
    }
